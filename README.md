...
This is a clean-room reimplementation of a churn-prediction platform I worked on at
Colt Technology Services. The production system and the customer data it ran on are
proprietary — neither appears here.

The architecture, feature design, and evaluation approach carry over. The code is written
from scratch and trained on a deterministic synthetic dataset generated by
`src/churn/data/synth.py`, so every metric in this repo is reproducible from a clean clone
